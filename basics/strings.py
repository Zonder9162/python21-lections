...
"==============Методы строк=================="
#  методы типов данных - функции, к тоторым мы обращаемся через точку 
dir() # посмотреть все методы класса (типы данных)
...
'hello world' .startswith('ls') # True
